...
2. **[보고서 생성]** 버튼을 누르면, 경영진/실무 보고서는 **2단계 파이프라인**으로 동작합니다.
...
4. 기본 HTML 템플릿은 슬라이드형(변수 1:1 매핑): summary, purpose_background, key_changes, process_flow, recommendations, risks, action_item. 사용자 프롬프트에서 추가한 변수·섹션은 동일 스타일로 슬라이드/섹션을 확장해 반영할 수 있습니다.
5. "만들어진 보고서 보기"로 팝업에서 HTML 보고서를 확인하고, 필요 시 HTML 또는 정리 내용(.md)을 다운로드합니다.
